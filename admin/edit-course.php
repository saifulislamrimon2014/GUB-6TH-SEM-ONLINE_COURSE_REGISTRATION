...
$ret=mysqli_query($con,"update course set courseCode='$coursecode',courseName='$coursename',department='$department',courseUnit='$courseunit',noofSeats='$seatlimit',updationDate='$currentTime' where id='$id'");
if($ret)
{
