...
$ret=mysqli_query($con,"insert into course(courseCode,courseName,department,courseUnit,noofSeats) values('$coursecode','$coursename','$department','$courseunit','$seatlimit')");
if($ret)
{
